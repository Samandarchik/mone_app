...
class _TechCardEditorPageState extends State<TechCardEditorPage> {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Nachinka uchun YAGONA palitra: tortdagi nachinkaning
                  // hamma qatlamlari rangi shu tanlovdan olinadi.
                  if (widget.showFillingColor)
                    FillingColorPalette(
                      title: 'Nachinka rangi',
  ...
  Widget _headerTables(bool wide) {
    ...
    // доп. расходы / прибыль / narx bloki — UMUMAN chiqmaydi.
